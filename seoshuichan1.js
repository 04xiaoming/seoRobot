...
var url = "http://www.shuichan.cc/article_list-125-134-"; //seo技术
var bigclass = "水产";
var contentInfo = "#font_word"; // 内容页面必须是唯一的
var listTitle = ".table a"; //列表页获取title

var utfCharset = 'gb2312'; //页面字符集
var arcList = [];
charset(agent); //
var i = 1,
curPage = 4;
...
let filterHtml=(html)=> {
    ...
    aPost.each(function () {
        ...
        let url = "http://www.shuichan.cc/"+ele.attr("href"); //具体到打开文章的url
